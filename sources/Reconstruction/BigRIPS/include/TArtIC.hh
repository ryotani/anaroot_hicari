...
class TArtIC : public TArtDataObject {
 ...
 public:
  ...
  virtual ~TArtIC(){}
  virtual void Clear(){nhitchannel=0;for(Int_t i=0;i<NUM_IC_CHANNEL;i++){fADC[i]=-9999;fADC_gainmatch[i]=-9999;fEnergy[i]=-9999;fTDC[i]=-9999;fTime[i]=-9999;}fRawADCSqSum=-9999;fRawADCAvSum=-9999;fCalMeVSqSum=-9999;fCalMeVAvSum=-9999;SetDataState(0);}
  ...
  virtual void SetGainMatchADC(Int_t ch, Double_t val){fADC_gainmatch[ch] = val;}
  ...
  virtual Int_t GetGainMatchADC(Int_t ch){return fADC_gainmatch[ch];}
 ...
 private:
  ...
  Double_t fADC_gainmatch[NUM_IC_CHANNEL];
